...
export const CreateTable: React.FC<CreateTableProps> = ({ onCancel, onFetch, visible }) => {
  ...
  return (
    ...
    >
      <Form layout="vertical" onFinish={onFinish} name="table_edit" form={form}>
        ...
        >
          <Input placeholder="Nome da mesa" onChange={(e) => setTitle(e.target.value)} />
        </Form.Item>
        ...
        >
          ...
          <Form.Item label="Capacidade da mesa" name="capacity" initialValue={4}>
